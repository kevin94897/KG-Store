    ...
    <div className="max-w-7xl mx-auto w-full min-h-dvh relative pt-14 pb-32 fade-up">
      ...
      >
        <div className="flex gap-2">
          ...
          <button
            onClick={handleWhatsApp}
            className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-semibold text-sm py-4 px-4 rounded-full active:brightness-90 transition-all"
          >
