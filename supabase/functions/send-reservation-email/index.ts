...
<body style="margin:0;padding:0;background:#0e0e0e;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:520px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#1c1c1c;border-radius:24px;padding:32px;border:1px solid rgba(255,255,255,0.06);">
      <p style="color:#c8a96e;font-size:12px;font-weight:700;letter-spacing:3px;text-transform:uppercase;margin:0 0 8px;">Reserva recibida</p>
      ...
      <!-- Código de reserva -->
      <div style="background:rgba(200,169,110,0.1);border:1px solid rgba(200,169,110,0.25);border-radius:16px;padding:20px;text-align:center;margin-bottom:24px;">
        ...
        <p style="color:#c8a96e;font-size:28px;font-weight:700;letter-spacing:6px;font-family:monospace;margin:0;">${reservation_code}</p>
      ...
      <div style="border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;margin-bottom:24px;">
        ...
        <div style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;justify-content:space-between;">
          <div>
            ...
            <p style="color:#c8a96e;font-size:16px;font-weight:700;margin:0;">${priceStr}</p>
          </div>
